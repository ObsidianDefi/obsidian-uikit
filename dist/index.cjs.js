...
var ObsidianRoundSml$1 = React__default['default'].memo(ObsidianRoundSml, function (prev, next) { return prev.isDark === next.isDark; });
...
styled.keyframes(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n\t50% {\n\t\ttransform: translatex(0px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t\ttransform: translatex(75%);\n\t}\n"])));
var Container = styled__default['default'].div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
styled__default['default'](ObsidianIcon)(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n  position: absolute;\n  padding-top: 1%;\n  margin: auto 0px;\n  text-align:center;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  padding-top: 1%;\n  margin: auto 0px;\n  text-align:center;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingCoinIcon = styled__default['default'](ObsidianIcon)(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  z-index: 1;\n  margin-top: 3px;\n  animation: ", " 5s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  z-index: 1;\n  margin-top: 3px;\n  animation: ", " 5s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
styled__default['default'](VChipIcon)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  z-index: 2;\n  top: 1%;\n  left: 1%;\n  animation: ", " 5s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  z-index: 2;\n  top: 1%;\n  left: 1%;\n  animation: ", " 5s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float1);
...
var StyledBottomNavItem$1 = styled__default['default'].button(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 8px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"], ["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 8px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledBottomNavItem = styled__default['default'](Flex$1)(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n"], ["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledFooter = styled__default['default'](Flex$1)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  background: #AAB7BF;\n"], ["\n  background: #AAB7BF;\n"])));
...
var ThemeSwitcher$3 = React__default['default'].memo(ThemeSwitcher$2, function (prev, next) { return prev.isDark === next.isDark; });
        ...
        React__default['default'].createElement(Flex$1, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default['default'].createElement(Flex$1, { order: [2, null, 1], alignItems: "center" },
                    React__default['default'].createElement(ThemeSwitcher$3, { isDark: isDark, toggleTheme: toggleTheme }),
                ...
                React__default['default'].createElement(Flex$1, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    React__default['default'].createElement(Button, { as: "a", href: "https://localhost:3000/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$1I, { color: lightColors.backgroundAlt }) }, buyObsnLabel))))));
};
...
var StyledSubMenuItems = styled__default['default'](Flex$1)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"], ["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Inner, { isPushed: false, showMenu: showMenu },
                children,
                React__default['default'].createElement(MenuItem$1, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, obsnPriceUsd: obsnPriceUsd, token2PriceUsd: token2PriceUsd, token3PriceUsd: token3PriceUsd, buyObsnLabel: buyObsnLabel, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            React__default['default'].createElement(WalletWrapper, { py: "24px", maxHeight: "453px", overflowY: "auto" },
                React__default['default'].createElement(Grid, { gridTemplateColumns: "1fr 1fr" },
                    ...
                    !showMore && React__default['default'].createElement(MoreWalletCard, { onClick: function () { return setShowMore(true); }, t: function (key) {
